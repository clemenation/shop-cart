...
<div class="wd-partners wd-partners-other">
	...
	<a href="#"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/slider-images/img4.jpg" alt="Image" /></a>
	<a href="#"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/slider-images/img5.jpg" alt="Image" /></a>	
...
<script type="text/javascript">
	$(document).ready(function() {
		$( ".wd-partners-other" ).imageScroller({speed:'3000', direction:'left'} );
	});
</script>
<div class="clear"></div>
