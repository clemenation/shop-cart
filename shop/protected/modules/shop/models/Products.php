...
class Products extends CActiveRecord
{
	...
	{
		return Yii::app()->getModule('shop')->productsTable;
	}
	...
	public function rules()
	{
		return array(
			...
			array('product_id,is_saleoff,category_id', 'numerical', 'integerOnly'=>true),
